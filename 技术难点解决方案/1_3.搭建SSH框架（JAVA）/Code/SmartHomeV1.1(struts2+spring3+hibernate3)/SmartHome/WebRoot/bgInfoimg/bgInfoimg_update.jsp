...
<html>
	...
	<body>
	<form action="${root}/bgInfoimgAction!update.action" method="post">
	<table>
  		<tr>
  			<td>infoImgId：</td>
  			<td><input type="text" id="bgInfoimg_infoImgId" name="bgInfoimg.infoImgId" value="${bgInfoimg.infoImgId}" readonly="readonly" /></td>
  		</tr>
  		<tr>
  			<td>infoId：</td>
